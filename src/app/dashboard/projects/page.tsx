...
const dummyProjects = [
  {
    ...
    description: "High-conversion landing page with dark mode and Framer Motion animations.",
  ...
  },
  {
    ...
    description: "Internal dashboard with charts, data tables, and user management.",
    status: "active" as const,
    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage and organize your AI generated applications.</p>
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0">
          ...
          <div className="flex items-center p-1 bg-muted/50 rounded-md border border-border/50">
            <Button 
              ...
              className={view === "grid" ? "bg-background shadow-sm h-7 w-7" : "h-7 w-7 text-muted-foreground"}
            >
            ...
            <Button 
              ...
              className={view === "list" ? "bg-background shadow-sm h-7 w-7" : "h-7 w-7 text-muted-foreground"}
            >
      ...
      {view === "grid" ? (
        ...
        <div className="rounded-xl border bg-card/50 backdrop-blur-sm overflow-hidden">
          <div className="p-4 text-center text-muted-foreground py-12">
            ...
            <Button variant="link" onClick={() => setView("grid")} className="mt-2">Switch back to grid</Button>
          </div>
        </div>
      )}
    </div>
